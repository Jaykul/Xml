...
function ConvertFrom-XmlDsl {
    ...
    [Array]$duds = $global:tokens | Where-Object { $_.Type -eq "Command" -and !$_.Content.Contains('-') -and ($Null -eq $(Get-Command $_.Content -Type Cmdlet,Function,ExternalScript -EA 0)) }
    if($duds) {
        [Array]::Reverse( $duds )
    }
